    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                setFollowersData(Array.isArray(followersResponse.data) ? followersResponse.data : []);
                setFollowingsData(Array.isArray(followingsResponse.data) ? followingsResponse.data : []);
            } catch (err) {
                setError(err);
            } finally {
                setLoading(false);
