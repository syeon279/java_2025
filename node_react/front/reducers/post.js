...
const reducer = (state = initialState, action) => produce(state, (draft) => {
  switch (action.type) {
    ...
    case REMOVE_POST_SUCCESS:
      console.log('reducer: REMOVE_POST_SUCCESS : ', action.data);
    ...
    case ADD_COMMENT_SUCCESS:
      ...
      if (post) {
        if (!post.Comments) {
          post.Comments = [];
          console.log('reducer: ADD_COMMENT_SUCCESS :!post.Comments:  ', post.Comments);
        }
        post.Comments = [action.data, ...post.Comments];
        console.log('reducer: ADD_COMMENT_SUCCESS : ', post.Comments);
      }
    ...
    case UNLIKE_POST_SUCCESS: {
      ...
      console.log('UNLIKE_POST_SUCCESS : ', post.Likers);
