	...
	<h3 class="contanier card-header p-3" style="background-color:#41644A;  color:#F1F0E9;" >MILK ORDER</h3>
		...
		<caption style = "text-align:center">milk 주문현황</caption>
			...
			try {
				...
				// sql 처리 
				pstmt = conn.prepareStatement("select * from milk_order_ order by ono desc limit 1;");
		...
		<div id="accordion">
		  <div class="card">
		    ...
		    <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
		      <div class="card-body" style = "padding-left: 50px; padding-right: 50px;">
				  <form action="milk_insert_.jsp" method ="post" onsubmit="return milkOrder()">
					<div class="mb-3 mt-3">
		  ...
		  <div class="card">
		    ...
		    <div id="collapseTwo" class="collapse" data-bs-parent="#accordion">
		      <div class="card-body" style = "padding-left: 50px; padding-right: 50px; ">
		         <form action="milk_update_.jsp" method = "post" onsubmit="return milkUpdate()">
		         	<div class="mb-3">
    ...
    <div id="collapseThree" class="collapse" data-bs-parent="#accordion">
      <div class="card-body" style = "padding-left: 50px; padding-right: 50px;"> 
			...
			<button type="submit" class="btn" style = "background-color:#E9762B; color:#F1F0E9;">주문 취소하기</button>
	     	...
	     	<script>
	     		function milkDelete() {
	     			let no = document.getElementById("num_delete");
	     			if(no.value == ""){
