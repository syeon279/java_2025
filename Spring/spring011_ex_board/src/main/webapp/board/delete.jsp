...
<%-- 	<%= request.getAttribute("dto") %>
	<%= request.getAttribute("result") %> --%>
		...
		<script>
			...
			<form action="delete.do" method = "post" onsubmit = "return form()" >
				...
				<div class = "d-flex justify-content-end m-3">
					...
					<button type="submit" title ="작성하기" class="btn btn-success m-1">삭제</button>
					<%-- <a href = "delete.do?bno=${dto.bno}&bpass=${dto.bpass}" class = "btn btn-success m-1">삭제</a> --%>
				</div>
